...
describe('Snackbar Component: ', () => {
    ...
    it('Renders properly', () => {
        ...
        expect(screen.getByLabelText('copy to clipboard button')).toBeInTheDocument();
        expect(screen.getByText(/Copy/i)).toBeInTheDocument();
        expect(screen.getByLabelText('copy to clipboard button')).not.toHaveAttribute('disabled');
    });
