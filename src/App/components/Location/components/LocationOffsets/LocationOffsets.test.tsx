...
describe('LocationOffsets in different conditions', () => {
  it('displays minutes and hours in plural', () => {
    render(
      <LocationOffsets type="light" hours={4} minutes={30} host={false} />
    );
  ...
  it('displays hour in singular and without minute', () => {
    render(<LocationOffsets type="light" hours={1} minutes={0} host={false} />);
  ...
  it('do not shows offsets if host is true', () => {
    render(
      <I18nextProvider i18n={i18n}>
        <LocationOffsets type="light" hours={2} minutes={30} host />
      </I18nextProvider>
    );
