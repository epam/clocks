...
describe('get object property function', () => {
  ...
  it('returns value if correct arguments given', () => {
    ...
    expect(getObjectProperty(data, 'student')).toEqual(
      expect.objectContaining({ name: 'John', age: 23 })
    );
  });
  it('should be available work with arrays', () => {
    ...
    expect(getObjectProperty(array, [1, 1])).toEqual(
      expect.arrayContaining(['testing is'])
    );
  });
});
