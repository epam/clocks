...
const useAutoTheme = () => {
  ...
  const { showDate, showCountry, showTimezone, theme, autoTheme, timeFormat } = useSelector(
  ...
  const setAutoTheme = () => {
    ...
    if (checkAutoThemeSupport !== 'not all') {
      ...
      dispatch(
        setSettings({ showDate, showCountry, showTimezone, theme, timeFormat, autoTheme: false })
      );
